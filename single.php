	  ...
	  <div class="deal-top-right-wrapper">
                         <div class="page-product-name-header"> 
							...
							<div class="DealDetailsTextWrappar">
								 <div class="page-product-price">Price:<?php echo get_post_meta($post->ID, 'Price', true);?></div>
								 <div class="page-market-price">Market Price : <?php echo get_post_meta($post->ID, 'Market Price', true);?>  </div>
								 <div class="page-market-price">Discount :<?php echo get_post_meta($post->ID, 'Discount', true);?>  </div>
						 ...
						 <div class="DealDetailsBuyButton">
							<div class="deal_purchase_wrapper">
								   <div><a id="BuyCoupon" class="deal_buy_button_text" href="#">Order Here </br> 019XXXXXXXX</a></div>
